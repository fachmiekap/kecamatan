...
include "tglindo.php"; 
$id_pemohon=$_GET['id'];
            $data=mysqli_query($con, "SELECT * FROM data_pemohon WHERE id_pemohon='$id_pemohon'");
...
<table width=100%>
<tr>
    <td align="center"><h3 style='margin-bottom:-5px' align=center>SURAT LAPORAN PEMOHON </h3></td>
</tr> 
<tr>
